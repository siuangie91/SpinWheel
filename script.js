...
//            s.blocker.addClass('open');
        ...
        var spinWheel = function(which) {
            ...
            if(!s.isSpinning) {
                ...
                which.prev('.pp-spoke').prev('.pp-spoke').children('.pp-spoke-color').addClass('small');
                which.next('.pp-spoke').next('.pp-spoke').children('.pp-spoke-color').addClass('small');
...
//                    s.blocker.removeClass('open');
        ...
        var displayOriginCoords = function() {
            ...
            s.originLocSpan.html("(" + s.originCoordsX.toString().substr(0,6) + "," + s.originCoordsY.toString().substr(0,6) + ")");
        };
...
//                    console.log('active spoke: ' + $('.accord.active').data('name'));
                    ...
                    $('.pp-accord[data-name="' + $(this).data('content') + '"]').addClass('active');
